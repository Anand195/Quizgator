  ...
  <div class="collapse navbar-collapse" id="navbarColor01">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?= base_url("index.php/login/index")?>">Profile<span class="sr-only">(current)</span></a>
      </li>
    </ul>
    ...
    <?php
          if($this->session->userdata('enrollment')){?>
            <li><a href="<?= base_url('index.php/profile/logout'); ?> " class="btn btn-danger">Logout</a></li>
