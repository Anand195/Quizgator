...
<?php echo form_open('profile/sendmail')?>
	...
	<div class="form-group">
		...
		<?php echo form_input(['class'=>'form-control','placeholder'=>'Enter Enrollment','name'=>'enrollment','value'=>set_value('enrollment')]);?>
		
	</div></div><div class="col-lg-6"style="margin-top :30px;"><?php echo form_error('enrollment'); ?></div></div>
